	...
	$(document).ready(function() {
		//uploadify
		  $('#file_upload').uploadify({
			...
			'script'    : 'scripts/upload_videos.php?id=' + $("#eid").val(), //script to upload our images
...
<table id="table-4" width="100%">
	<form name="form1" id="form1" method="post" action="" onSubmit="return validation(this)">
		...
		<tr>
			...
			<td>
				<?php file_download_link($config_data['folder']."/".$movie_gallery_data['link'][$i],$movie_gallery_data['title'][$i],"Download Video","Video Broken"); ?>
			</td>
			<td>
				<a title="Edit" href="main.php?page=control_main&cpage=control_movie_gallery_edit&id=<?php echo $movie_gallery_data['id'][$i]; ?>">
