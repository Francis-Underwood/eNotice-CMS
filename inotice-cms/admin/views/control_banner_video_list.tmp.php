...
<div class="mws-panel grid_8">
	...
	<div class="mws-panel-body">
		<form class="mws-form" name="form1" id="form1" method="post" action="" onSubmit="return validation(this)">
			...
			?>
			<?php 
				$disable_re_order_btn = (($banner_video_count) <= 1)?("disabled"):("");
			...
			<table class="mws-table">
				...
				?>
					<tr class="gradeC">
						...
						<td>
							<a href="main.php?page=control_banner_video_edit&id=<?php echo $banner_video_data['id'][$i]; ?>"><img src="mws-admin/css/icons/16/edit.png"></a>
						</td>
					</tr>
				<?php 
						} 
						...
						{
							show_system_msg("", "", "No Video for Banner!!");;
						}
				?>
				</tbody>
			</table>
			...
			<div class="mws-button-row">
				<input class="mws-button left green mws-i-24 i-cross large" type="submit" name="submit" value="Del selected Videos"/>
				<input class="mws-button green" onclick="$('#file_upload').uploadify('upload','*');" type="button" value="Upload" />
				<input class="mws-button green" onclick="location='main.php?page=control_banner_video_sort'" type="button" value="Re-order Videos" <?php echo $disable_re_order_btn;?>/>
			</div>
			<!-- End Botton Bar -->	
