...
<form name="form1" id="form1" method="post" action="" onSubmit="return validation(this)">
	...
	<tr>
		...
		<td colspan="2"><input name="xdate" type="text" id="xdate" value="<?php echo ($mode == "edit")?$gallery_album_data['xdate_str'][0]:(date("Y-m-d"));?>" maxlength="10"/></td>
	</tr>
	<tr>
		<td width="186">&nbsp;</td>
		<td width="186">&nbsp;</td>
	...
	<tr>
		...
		<td align="right" valign="middle" colspan="1" height="50">
			<input name="back" type="button" class="button" id="back" value="Cancel" onClick="location='main.php?page=control_main&cpage=control_gallery_list'">
		</td>
	</tr>
</form>
</table>
