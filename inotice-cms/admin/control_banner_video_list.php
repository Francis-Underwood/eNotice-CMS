...
<form name="form1" id="form1" method="post" action="" onSubmit="return validation(this)">
	...
	<tr height="50">
		<td><font color="#000000"><?php echo $banner_video_count-$i; ?></font></td>
		<td>
			<a title="Download Video" href="<?php echo $config_data['folder']."/".$banner_video_data['link'][$i]; ?>"><?php echo $banner_video_data['title'][$i]; ?></a>
		</td>
		<td>
