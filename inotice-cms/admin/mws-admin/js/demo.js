$(document).ready(function() {
	...
	$(".mws-datepicker-wk").datepicker({showOtherMonths:true, showWeek:true, dateFormat:"yy-mm-dd"});
	...
	/* Full Calendar */	/* delby Vincent 31st-Aug-2012 */
	/*
	var date = new Date();
	var d = date.getDate();
	var m = date.getMonth();
	...
	*/
	...
	/* Sourcerer */	/* delby Vincent 31st-Aug-2012 */
	/*
